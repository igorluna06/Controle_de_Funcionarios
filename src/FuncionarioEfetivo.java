public class FuncionarioEfetivo extends Funcionario implements Bonificacao{

    public FuncionarioEfetivo(String name, int age, String position, double salarioBase){
